...
int find_scc_with_adj_list(const std::vector<std::vector<int>>&adj,int num_v,int num_e,std::vector<int>&ans){
	ans[0] = 0;
	ans[1] = 0;
	ans[2] = 0;
	ans[3] = 1;
...
int find_scc_with_adj_mat(const std::vector<std::vector<int>>&adj,int num_v,int num_e,std::vector<int>&ans){
	ans[0] = 0;
	ans[1] = 0;
	ans[2] = 0;
	ans[3] = 1;
